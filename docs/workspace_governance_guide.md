...
**Covers:** git pre-commit hook · PR check · all 7 workspace commands · scope routing
...
Run `ai-gov workspace-init` once at your workspace root. It scans every project, detects the stack, and writes governance files at two levels.
...
*Generated by ai-gov v16.0.0 — update this document after major workspace changes.*
